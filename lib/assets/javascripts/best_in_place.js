      ...
      if (event.data.editor.okButton) {
        event.data.editor.blurTimer = setTimeout(function () {
          if (!event.data.editor.userClicked) {	
            if (event.data.editor.getValue() != event.data.editor.sanitizeValue(event.data.editor.display_value)) {
  ...
  jQuery.fn.extend({
    elastic: function() {
      ...
      return this.each( function() {
        ...
        // NOTE: Commented out because the compacting of the textarea changes the location of the ok/cancel buttons
        //       and results in the ok/cancel event being ignored when the button is clicked on the lower area of the
        //       button.
        //
